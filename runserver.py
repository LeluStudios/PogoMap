...
if __name__ == '__main__':
    ...
    if res:
        ...
        posnew = [position[0],position[1],position[2]]
        if args.account_index == 1:
            posnew[0] = poslat +(4.5*0.0009)
            posnew[1] = poslon +(1*0.001280475)
        elif args.account_index == 2:
            posnew[0] = poslat +(1.5*0.0009)
            posnew[1] = poslon +(5*0.001280475)
        elif args.account_index == 3:
            posnew[0] = poslat -(3*0.0009)
            posnew[1] = poslon +(4*0.001280475)
